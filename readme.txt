...
NB:
le dossier lib contient les deux drivers jdatePicker pour configurer le choix de la date sur notre projet et le mysql connector.
le rapport et la présentation ppt sont tous présent dans ce répértoire


Pour se connecter en tant que Administrateur utiliser le compte suivant:
	mail: said-Elkafhali@gmail.com	
	mdp: said123
