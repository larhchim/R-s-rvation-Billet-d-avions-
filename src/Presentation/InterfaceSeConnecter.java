...
public class InterfaceSeConnecter extends JPanel{
	...
	public void paintComponent(Graphics A) {
		...
		Image avionimg;
		try {
			avionimg = ImageIO.read(new File("C:\\Users\\hp-pc\\Desktop\\ReservationBilletsAvions\\ReservationBilletsAvion\\src\\Presentation\\InterfaceSeconnecter.jpg"));
